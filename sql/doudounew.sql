...
Source Database       : qy93

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2019-07-23 12:31:39
*/
...
CREATE TABLE `goodsinfo` (
  ...
  `goods_type` int(11) DEFAULT NULL COMMENT '商品种类',
  `goods_spec` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '商品规格',
  `goods_price` float DEFAULT NULL COMMENT '商品价格',
  `goods_date` datetime DEFAULT NULL COMMENT '建账时间',
...
-- ----------------------------
INSERT INTO `goodsinfo` VALUES ('1', '方便面', '1', 'tm-1', '12', '2019-07-23 11:05:36');
INSERT INTO `goodsinfo` VALUES ('2', '火腿肠2', '1', 'tm-3', '25', '2012-12-12 00:00:00');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('100', '0', '0', '豆豆科技', '0', '豆豆', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
...
INSERT INTO `sys_menu` VALUES ('2010', '商品', '3', '1', '/system/goodsinfo', 'C', '0', 'system:goodsinfo:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '商品菜单');
...
INSERT INTO `sys_menu` VALUES ('2015', '类型', '3', '1', '/system/typeinfo', 'C', '0', 'system:typeinfo:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '类型菜单');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '豆豆', '00', '86521760@qq.com', '18538062907', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-07-23 12:01:35', 'admin', '2018-03-16 11:33:00', 'ry', '2019-07-23 12:01:34', '管理员');
INSERT INTO `sys_user` VALUES ('2', '105', 'ry', '豆豆', '00', 'ry@qq.com', '15666666666', '1', '', '8e6d98b90472783cc73c17047ddccf36', '222222', '0', '2', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', 'admin', '2019-04-18 09:53:36', '测试员');
INSERT INTO `sys_user` VALUES ('3', '108', 'chenjian', '陈建', '00', 'chenjian3822515@163.com', '18538062906', '0', '', '46894954cd34c0fbd454a5083bd886f1', '4bd21f', '0', '0', '', null, 'admin', '2019-04-18 11:48:31', 'admin', '2019-07-23 09:57:02', '');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('32d88fe1-3f96-4591-9aaa-4d23bafab365', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Firefox', 'Windows 7', 'on_line', '2019-07-23 12:01:28', '2019-07-23 12:09:21', '1800000');
...
CREATE TABLE `typeinfo` (
  `type_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '种类编号',
  `type_name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '种类名称',
  PRIMARY KEY (`type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='类型信息表';

-- ----------------------------
-- Records of typeinfo
-- ----------------------------
INSERT INTO `typeinfo` VALUES ('1', '糖果类');
INSERT INTO `typeinfo` VALUES ('2', '烟酒类');
INSERT INTO `typeinfo` VALUES ('4', '计生类');
